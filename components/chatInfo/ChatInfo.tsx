...
const ChatInfo = () => {
  return (
    <div
      ...
      className="z-10 w-full sm:w-80 lg:w-auto bg-cover fixed inset-[0_0_0_auto] lg:static shadow-xl sm:shadow-[var(--purple-500)] lg:shadow-transparent duration-300"
    >
